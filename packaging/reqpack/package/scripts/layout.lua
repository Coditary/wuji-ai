...
function M.paths(context)
  ...
  local package_root = M.join_path(share_root, "wuji")
  ...
  local package_doc_dir = M.join_path(doc_dir, "wuji")
  local stable_bin_dir = M.join_path(local_root, "bin")
  local binary_path = M.join_path(bin_dir, "wuji")
  local symlink_path = M.join_path(stable_bin_dir, "wuji")
